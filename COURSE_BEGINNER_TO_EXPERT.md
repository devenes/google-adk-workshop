...
**Colab original (optional):** [`ADK_Learning_tools.ipynb`](ADK_Learning_tools.ipynb) — align with codelab _Session 1–2_.
...
**Colab / codelab alignment:** _Session 4 (memory)_ in the [Codelab guide](https://codelabs.developers.google.com/onramp/instructions#0).
...
```bash
cd google-adk-workshop && source .venv/bin/activate && pytest tests/ -v
```
