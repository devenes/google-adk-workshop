...
- **Models:** confirm the same model IDs (`gemini-2.5-flash`, etc.) are available in your region and billing project.
- **Tooling:** HTTP tools (`live_weather_nws`, Wikipedia helpers) need outbound network from the deployed environment.
